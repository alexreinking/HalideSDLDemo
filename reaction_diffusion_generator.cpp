// Adapted from upstream Halide's HelloWasm code (MIT-licensed)
// https://github.com/halide/Halide/blob/98fdd9a1580024125a9d0a742633792485b0f559/apps/HelloWasm/reaction_diffusion_generator.cpp
#include <Halide.h>
...
namespace {
    ...
    public:
        ...
        void schedule() {
            if (auto_schedule) {
                output.set_estimates({{0, 640}, {0, 480}, {0, 3}});
            }
        }
    ...
    public:
        ...
        void schedule() {
            if (auto_schedule) {
                state.set_estimates({{0, 640}, {0, 480}, {0, 3}});
                mouse_x.set_estimate(640 / 2);
                mouse_y.set_estimate(480 / 2);
                frame.set_estimate(0);
                new_state.set_estimates({{0, 640}, {0, 480}, {0, 3}});
            }
        }
    ...
    public:
        ...
        void schedule() {
            if (auto_schedule) {
                render.set_estimates({{0, 640}, {0, 480}});
            }
        }
